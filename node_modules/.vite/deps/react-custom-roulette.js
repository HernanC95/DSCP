    ...
    !function(e, t) {
      ...
      return function(e2) {
        ...
        return n.m = e2, n.c = t, n.d = function(e3, t2, r) {
          ...
          if (n.r(r), Object.defineProperty(r, "default", { enumerable: true, value: e3 }), 2 & t2 && "string" != typeof e3) for (var i in e3) n.d(r, i, (function(t3) {
            return e3[t3];
          }).bind(null, i));
          return r;
        }, n.n = function(e3) {
        ...
        (function(e3) {
          ...
          var p = function(e4, t2) {
            for (var n2 = [e4[0]], r2 = 0, i2 = t2.length; r2 < i2; r2 += 1) n2.push(t2[r2], e4[r2 + 1]);
            return n2;
          }, g = function(e4) {
          ...
          var x = function() {
            ...
            return t2.indexOfGroup = function(e5) {
              for (var t3 = 0, n2 = 0; n2 < e5; n2++) t3 += this.groupSizes[n2];
              return t3;
            }, t2.insertRules = function(e5, t3) {
              if (e5 >= this.groupSizes.length) {
                for (var n2 = this.groupSizes, r2 = n2.length, i2 = r2; e5 >= i2; ) (i2 <<= 1) < 0 && A(16, "" + e5);
                this.groupSizes = new Uint32Array(i2), this.groupSizes.set(n2), this.length = i2;
                for (var o2 = r2; o2 < i2; o2++) this.groupSizes[o2] = 0;
              }
              for (var a2 = this.indexOfGroup(e5 + 1), s2 = 0, c2 = t3.length; s2 < c2; s2++) this.tag.insertRule(a2, t3[s2]) && (this.groupSizes[e5]++, a2++);
              ...
              for (var n2 = this.groupSizes[e5], r2 = this.indexOfGroup(e5), i2 = r2 + n2, o2 = r2; o2 < i2; o2++) t3 += this.tag.getRule(o2) + "/*!sc*/\n";
              return t3;
            }, e4;
            ...
            for (var r2, i2 = n2.split(","), o2 = 0, a2 = i2.length; o2 < a2; o2++) (r2 = i2[o2]) && e4.registerName(t2, r2);
          }, N = function(e4, t2) {
            ...
            var t2 = document.head, n2 = e4 || t2, r2 = document.createElement("style"), i2 = function(e5) {
              for (var t3 = e5.childNodes, n3 = t3.length; n3 >= 0; n3--) {
                var r3 = t3[n3];
                if (r3 && 1 === r3.nodeType && r3.hasAttribute(S)) return r3;
              }
            ...
            return t2.reconstructWithOptions = function(t3, n2) {
              ...
              if (P(e5), this.names.has(e5)) this.names.get(e5).add(t3);
              else {
          ...
          function U(e4) {
            var t2, n2 = "";
            for (t2 = Math.abs(e4); t2 > 52; t2 = t2 / 52 | 0) n2 = $(t2 % 52) + n2;
            return ($(t2 % 52) + n2).replace(K, "$1-$2");
          }
          var q = function(e4, t2) {
            for (var n2 = t2.length; n2; ) e4 = 33 * e4 ^ t2.charCodeAt(--n2);
            return e4;
          }, X = function(e4) {
            return q(5381, e4);
          };
          ...
          var Y = X("5.2.1"), Q = function() {
            ...
            return e4.prototype.generateAndInjectStyles = function(e5, t2, n2) {
              ...
              if (this.baseStyle && i2.push(this.baseStyle.generateAndInjectStyles(e5, t2, n2)), this.isStatic && !n2.hash) if (this.staticRulesId && t2.hasNameForId(r2, this.staticRulesId)) i2.push(this.staticRulesId);
              else {
          ...
          function ee(e4) {
            var t2, n2, r2, i2, o2 = void 0 === e4 ? v : e4, a2 = o2.options, s2 = void 0 === a2 ? v : a2, l2 = o2.plugins, u2 = void 0 === l2 ? m : l2, f2 = new c.a(s2), h2 = [], d2 = /* @__PURE__ */ function(e5) {
              ...
              return function(n3, r3, i3, o3, a3, s3, c2, l3, u3, f3) {
                switch (n3) {
                  case 1:
                    if (0 === u3 && 64 === r3.charCodeAt(0)) return e5(r3 + ";"), "";
                    break;
                  case 2:
                    if (0 === l3) return r3 + "/*|*/";
                    break;
          ...
          function ge(e4, t2, n2, r2) {
            if (Array.isArray(e4)) {
              for (var i2, o2 = [], a2 = 0, s2 = e4.length; a2 < s2; a2 += 1) "" !== (i2 = ge(e4[a2], t2, n2, r2)) && (Array.isArray(i2) ? o2.push.apply(o2, i2) : o2.push(i2));
              return o2;
            }
            return pe(e4) ? "" : w(e4) ? "." + e4.styledComponentId : y(e4) ? "function" != typeof (c2 = e4) || c2.prototype && c2.prototype.isReactComponent || !t2 ? e4 : ge(e4(t2), t2, n2, r2) : e4 instanceof ce ? n2 ? (e4.inject(n2, r2), e4.getName(r2)) : e4 : g(e4) ? function e5(t3, n3) {
              var r3, i3, o3 = [];
              for (var a3 in t3) t3.hasOwnProperty(a3) && !pe(t3[a3]) && (g(t3[a3]) ? o3.push.apply(o3, e5(t3[a3], a3)) : y(t3[a3]) ? o3.push(de(a3) + ":", t3[a3], ";") : o3.push(de(a3) + ": " + (r3 = a3, (null == (i3 = t3[a3]) || "boolean" == typeof i3 || "" === i3 ? "" : "number" != typeof i3 || 0 === i3 || r3 in l.a ? String(i3).trim() : i3 + "px") + ";")));
          ...
          function Oe(e4) {
            ...
            for (var i2 = 0, o2 = n2; i2 < o2.length; i2++) {
              var a2 = o2[i2];
              if (Ce(a2)) for (var s2 in a2) Ae(s2) && xe(e4, a2[s2], s2);
            }
            return e4;
          }
          ...
          function Pe(e4, t2, n2) {
              ...
              return function(e6, t4, n3, r3) {
                var o2 = e6.attrs, a3 = e6.componentStyle, s3 = e6.defaultProps, c3 = e6.foldedComponentIds, l3 = e6.shouldForwardProp, f3 = e6.styledComponentId, h2 = e6.target, p3 = function(e7, t5, n4) {
                  ...
                  return n4.forEach(function(e8) {
                    var t6, n5, o3, a4 = e8;
                    for (t6 in y(a4) && (a4 = a4(r4)), a4) r4[t6] = i2[t6] = "className" === t6 ? (n5 = i2[t6], o3 = a4[t6], n5 && o3 ? n5 + " " + o3 : n5 || o3) : a4[t6];
                  }), [r4, i2];
                ...
                for (var x3 in C3) "$" !== x3[0] && "as" !== x3 && ("forwardedAs" === x3 ? A3.as = C3[x3] : (l3 ? l3(x3, u.a) : !k3 || Object(u.a)(x3)) && (A3[x3] = C3[x3]));
            ...
            return T2.displayName = g2, (A2 = o.a.forwardRef(T2)).attrs = k2, A2.componentStyle = x2, A2.displayName = g2, A2.shouldForwardProp = C2, A2.foldedComponentIds = r2 ? Array.prototype.concat(e4.foldedComponentIds, e4.styledComponentId) : m, A2.styledComponentId = S2, A2.target = r2 ? e4.target : e4, A2.withComponent = function(e5) {
              var r3 = t2.componentId, i2 = function(e6, t3) {
                ...
                for (r4 = 0; r4 < o3.length; r4++) n3 = o3[r4], t3.indexOf(n3) >= 0 || (i3[n3] = e6[n3]);
                return i3;
          ...
          var Ee = function(e4) {
            return function e5(t2, n2, i2) {
              if (void 0 === i2 && (i2 = v), !Object(r.isValidElementType)(n2)) return A(1, String(n2));
              var o2 = function() {
        ...
        !function() {
          ...
          function u(e3, t2, n2, r2) {
            if (t2 = e3.c.createElement(t2), n2) for (var i2 in n2) n2.hasOwnProperty(i2) && ("style" == i2 ? t2.style.cssText = n2[i2] : t2.setAttribute(i2, n2[i2]));
          ...
          function d(e3, t2, n2) {
            ...
            for (var r2 = e3.className.split(/\s+/), i2 = 0; i2 < t2.length; i2 += 1) {
              for (var o2 = false, a2 = 0; a2 < r2.length; a2 += 1) if (t2[i2] === r2[a2]) {
                o2 = true;
                break;
              }
              o2 || r2.push(t2[i2]);
            ...
            for (t2 = [], i2 = 0; i2 < r2.length; i2 += 1) {
              for (o2 = false, a2 = 0; a2 < n2.length; a2 += 1) if (r2[i2] === n2[a2]) {
                o2 = true;
                break;
              }
              o2 || t2.push(r2[i2]);
          ...
          function p(e3, t2) {
            for (var n2 = e3.className.split(/\s+/), r2 = 0, i2 = n2.length; r2 < i2; r2++) if (n2[r2] == t2) return true;
            return false;
          }
          function g(e3, t2, n2) {
            function r2() {
          ...
          S.prototype.c = function(e3) {
            for (var t2 = [], n2 = 0; n2 < arguments.length; n2++) t2.push(arguments[n2].replace(/[\W_]+/g, "").toLowerCase());
          ...
          function B(e3, t2, n2) {
            for (var r2 in W) if (W.hasOwnProperty(r2) && t2 === e3.f[W[r2]] && n2 === e3.f[W[r2]]) return true;
            return false;
          }
          function F(e3) {
          ...
          function U(e3, t2, n2, r2, i2) {
            ...
            (e3.f || e3.g) && setTimeout(function() {
              ...
              if (0 === n2.length && o2) j(t2.a);
              else {
                t2.f += n2.length, o2 && (t2.j = o2);
                var c2, l2 = [];
                for (c2 = 0; c2 < n2.length; c2++) {
                  var u2 = n2[c2], f2 = s2[u2.c], h2 = t2.a, p2 = u2;
                  if (h2.g && d(h2.f, [h2.a.c("wf", p2.c, A(p2).toString(), "loading")]), P(h2, "fontloading", p2), h2 = null, null === _) if (window.FontFace) {
                ...
                for (c2 = 0; c2 < l2.length; c2++) l2[c2].start();
              }
            }, 0);
          }
          function q(e3, t2) {
          ...
          G.prototype.g = function(e3) {
            ...
            this.c = new c(this.j, e3.context || this.j), this.g = false !== e3.events, this.f = false !== e3.classes, function(e4, t2, n2) {
              ...
              for (e4.h = r2.length, t2 = 0, n2 = r2.length; t2 < n2; t2++) r2[t2].load(function(t3, n3, r3) {
                U(e4, o2, t3, n3, r3);
              });
              ...
              m(this.c, (t2.a.api || "https://fast.fonts.net/jsapi") + "/" + n2 + ".js" + (r2 ? "?v=" + r2 : ""), function(r3) {
                r3 ? e3([]) : (i2["__MonotypeConfiguration__" + n2] = function() {
                  ...
                  if (i2["__mti_fntLst" + n2]) {
                    ...
                    if (o2) for (var s2 = 0; s2 < o2.length; s2++) {
            ...
            for (t2 = 0, n2 = r2.length; t2 < n2; t2++) g(this.c, r2[t2], y(a2));
            var s2 = [];
            for (t2 = 0, n2 = i2.length; t2 < n2; t2++) if ((r2 = i2[t2].split(":"))[1]) for (var c2 = r2[1].split(","), l2 = 0; l2 < c2.length; l2 += 1) s2.push(new k(r2[0], c2[l2]));
            else s2.push(new k(r2[0]));
            b(a2, function() {
              e3(s2, o2);
            });
          };
          ...
          ne.prototype.load = function(e3) {
            ...
            !function(e4) {
              for (var t3 = e4.f.length, n3 = 0; n3 < t3; n3++) {
                ...
                if (2 <= r3.length) {
                  var a2;
                  if (a2 = [], s2 = r3[1]) for (var s2, c2 = (s2 = s2.split(",")).length, l2 = 0; l2 < c2; l2++) {
                    var u2;
                    if ((u2 = s2[l2]).match(/^[\w-]+$/)) if (null == (h2 = te.exec(u2.toLowerCase()))) u2 = "";
                    else {
                      if (u2 = null == (u2 = h2[2]) || "" == u2 ? "n" : ee[u2], null == (h2 = h2[1]) || "" == h2) h2 = "4";
                      else var f2 = Z[h2], h2 = f2 || (isNaN(h2) ? "4" : h2.substr(0, 1));
                      u2 = [u2, h2].join("");
                    }
                    else u2 = "";
                    u2 && a2.push(u2);
                ...
                for (e4.c[i3] || (r3 = V[i3]) && (e4.c[i3] = r3), r3 = 0; r3 < o3.length; r3 += 1) e4.a.push(new k(i3, o3[r3]));
              }
            }(o2), g(n2, function(e4) {
              if (0 == e4.a.length) throw Error("No fonts to load!");
              if (-1 != e4.c.indexOf("kit=")) return e4.c;
              for (var t3 = e4.a.length, n3 = [], r3 = 0; r3 < t3; r3++) n3.push(e4.a[r3].replace(/ /g, "+"));
            ...
            t2 ? m(this.c, (this.a.api || "https://use.typekit.net") + "/" + t2 + ".js", function(t3) {
              if (t3) e3([]);
                ...
                for (var r2 = [], i2 = 0; i2 < t3.length; i2 += 2) for (var o2 = t3[i2], a2 = t3[i2 + 1], s2 = 0; s2 < a2.length; s2++) r2.push(new k(o2, a2[s2]));
                try {
        ...
        e2.exports = function(e3, t2, n, r) {
          ...
          for (var s = Object.prototype.hasOwnProperty.bind(t2), c = 0; c < o.length; c++) {
            ...
            if (!s(l)) return false;
            var u = e3[l], f = t2[l];
            if (false === (i = n ? n.call(r, u, f, l) : void 0) || void 0 === i && u !== f) return false;
          }
          return true;
        };
      }, function(e2, t, n) {
        ...
        t.a = function(e3) {
          function t2(e4, t3, r2) {
            ...
            switch (a2) {
              ...
              case 1:
                var s2 = 0;
                for (e4 = 0 === a2 ? "" : e4[0] + " "; s2 < o2; ++s2) t3[s2] = n2(e4, t3[s2], r2).trim();
                break;
              default:
                var c2 = s2 = 0;
                for (t3 = []; s2 < o2; ++s2) for (var l2 = 0; l2 < a2; ++l2) t3[c2++] = n2(e4[l2] + " ", i2[s2], r2).trim();
            }
            return t3;
          }
          function n2(e4, t3, n3) {
            ...
            switch (33 > r2 && (r2 = (t3 = t3.trim()).charCodeAt(0)), r2) {
              ...
              default:
                if (0 < 1 * n3 && 0 < t3.indexOf("\f")) return t3.replace(g, (58 === e4.charCodeAt(0) ? "" : "$1") + e4.trim());
            }
            return e4 + t3;
          }
          function r(e4, t3, n3, o2) {
            ...
            switch (s2) {
              ...
              case 883:
                ...
                if (0 < a2.indexOf("image-set(", 11)) return a2.replace(x, "$1-webkit-$2") + a2;
                break;
              case 932:
              ...
              case 931:
              case 953:
                if (true === A.test(e4)) return 115 === (c2 = e4.substring(e4.indexOf(":") + 1)).charCodeAt(0) ? r(e4.replace("stretch", "fill-available"), t3, n3, o2).replace(":fill-available", ":stretch") : a2.replace(c2, "-webkit-" + c2) + a2.replace(c2, "-moz-" + c2.replace("fill-", "")) + a2;
                break;
              case 962:
                if (a2 = "-webkit-" + a2 + (102 === a2.charCodeAt(5) ? "-ms-" + a2 : "") + a2, 211 === n3 + o2 && 105 === a2.charCodeAt(13) && 0 < a2.indexOf("transform", 10)) return a2.substring(0, a2.indexOf(";", 27) + 1).replace(d, "$1-webkit-$2") + a2;
            }
            return a2;
          }
          function i(e4, t3) {
          ...
          function a(e4, t3, n3, r2, i2, o2, a2, s2, l2, u2) {
            for (var f2, h2 = 0, d2 = t3; h2 < I; ++h2) switch (f2 = R[h2].call(c, e4, d2, n3, r2, i2, o2, a2, s2, l2, u2)) {
              case void 0:
              case false:
              case true:
              case null:
          ...
          function c(e4, n3) {
            ...
            var f2 = function e5(n4, s3, c3, f3, h2) {
              for (var d2, p2, g2, b2, S2, k2 = 0, C2 = 0, A2 = 0, x2 = 0, R2 = 0, M2 = 0, N = g2 = d2 = 0, W = 0, z = 0, D = 0, B = 0, F = c3.length, H = F - 1, G = "", _ = "", K = "", $ = ""; W < F; ) {
                if (p2 = c3.charCodeAt(W), W === H && 0 !== C2 + x2 + A2 + k2 && (0 !== C2 && (p2 = 47 === C2 ? 10 : 47), x2 = A2 = k2 = 0, F++, H++), 0 === C2 + x2 + A2 + k2) {
                  ...
                  switch (p2) {
                    case 123:
                        ...
                        switch (p2 = c3.charCodeAt(W)) {
                          ...
                          case 47:
                            switch (p2 = c3.charCodeAt(W + 1)) {
                              ...
                              case 47:
                                e: {
                                  for (N = W + 1; N < H; ++N) switch (c3.charCodeAt(N)) {
                                    case 47:
                      ...
                      switch (g2 = c3.substring(B, W), 0 === d2 && (d2 = (G = G.replace(l, "").trim()).charCodeAt(0)), d2) {
                        case 64:
                          ...
                          if (B = (g2 = e5(s3, z, g2, p2, h2 + 1)).length, 0 < I && (S2 = a(3, g2, z = t2(E, G, D), s3, T, O, B, p2, h2, f3), G = z.join(""), void 0 !== S2 && 0 === (B = (g2 = S2.trim()).length) && (p2 = 0, g2 = "")), 0 < B) switch (p2) {
                            case 115:
                              G = G.replace(w, o);
                            case 100:
                            case 109:
                    ...
                    case 125:
                    case 59:
                      if (1 < (B = (G = (0 < z ? G.replace(u, "") : G).trim()).length)) switch (0 === N && (d2 = G.charCodeAt(0), 45 === d2 || 96 < d2 && 123 > d2) && (B = (G = G.replace(" ", ":")).length), 0 < I && void 0 !== (S2 = a(1, G, s3, n4, T, O, _.length, f3, h2, f3)) && 0 === (B = (G = S2.trim()).length) && (G = "\0\0"), d2 = G.charCodeAt(0), p2 = G.charCodeAt(1), d2) {
                        case 0:
                          break;
                        case 64:
                          if (105 === p2 || 99 === p2) {
                  ...
                  default:
                    switch (O++, b2 = c3.charAt(W), p2) {
                      ...
                      case 38:
                        ...
                        break;
                      case 108:
                        if (0 === x2 + C2 + k2 + j && 0 < N) switch (W - N) {
                          case 2:
              ...
              if (0 < (B = _.length)) {
                if (z = s3, 0 < I && (void 0 !== (S2 = a(2, _, z, n4, T, O, B, f3, h2, f3)) && 0 === (_ = S2).length)) return $ + _ + K;
                if (_ = z.join(",") + "{" + _ + "}", 0 != P * j) {
          ...
          return c.use = function e4(t3) {
            switch (t3) {
              ...
              case null:
                ...
                break;
              default:
                if ("function" == typeof t3) R[I++] = t3;
                else if ("object" == typeof t3) for (var n3 = 0, r2 = t3.length; n3 < r2; ++n3) e4(t3[n3]);
                else L = 0 | !!t3;
            }
            return e4;
        ...
        function s(e3) {
          if (n === setTimeout) return setTimeout(e3, 0);
          if ((n === o || !n) && setTimeout) return n = setTimeout, setTimeout(e3, 0);
          try {
            return n(e3, 0);
          } catch (t2) {
            try {
...
`;
        var k = function(e3, t2, n2, r2, i2, o2) {
          ...
          return (A = Object.assign || function(e3) {
            for (var t2, n2 = 1, r2 = arguments.length; n2 < r2; n2++) for (var i2 in t2 = arguments[n2]) Object.prototype.hasOwnProperty.call(t2, i2) && (e3[i2] = t2[i2]);
            return e3;
          }).apply(this, arguments);
        }, x = function(e3, t2, n2) {
          ...
          var t2 = e3.mustStartSpinning, n2 = e3.prizeNumber, o2 = e3.data, f2 = e3.onStopSpinning, m2 = void 0 === f2 ? function() {
            ...
            for (var t3 = "", n3 = p.length, r2 = 0; r2 < e4; r2++) t3 += p.charAt(Math.floor(Math.random() * n3));
            return t3;
          ...
          Object(r.useEffect)(function() {
            for (var e4, t3, n3, r2, i2, l2, u2, f3, d2, p2, g2 = 0, m3 = [], v3 = (null == o2 ? void 0 : o2.length) || 0, y2 = [{ option: "", optionSize: 1 }], b2 = h(null == G ? void 0 : G.trim()) ? [G] : [], w2 = function(a2) {
              ...
              for (var w3 = 0; w3 < (y2[a2].optionSize || 1); w3++) m3[a2][w3] = g2++;
              if (o2[a2].image) {
                Be(function(e5) {
                  return e5 + 1;
                });
            ...
            if ((null == b2 ? void 0 : b2.length) > 0) try {
